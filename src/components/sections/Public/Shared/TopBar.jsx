...
const TopBar = () => {
  return (
    <div className="bg-navy text-white/90 py-2 border-b border-white/5">
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href="#"
            className="text-white/60 hover:text-brand transition-all transform hover:-translate-y-0.5"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
