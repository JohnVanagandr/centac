  ...
  return (
    <div className="animate-in fade-in space-y-8 max-w-4xl mx-auto pb-10">
      ...
      <div className="flex items-center justify-between border-b border-slate-100 pb-4">
        <div>
          <h2 className="text-2xl font-black text-navy tracking-tight">Editar Slider #{id}</h2>
          <p className="text-sm text-slate-500 mt-1 font-medium">Configura la imagen de portada y los textos del banner.</p>
        </div>
        <button 
          type="button"
