  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <PageHeader
        ...
        description="Conoce nuestra misión, visión y los pilares que guían la excelencia en la formación profesional integral en CENTAC."
      />

      {/* 2. Cuerpo de la Página (Estado: Próximamente) */}
      <div className="flex-grow flex items-center justify-center p-6 lg:p-12">
        <div className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100 text-center max-w-lg w-full">
          ...
          <p className="text-slate-500 mb-8 leading-relaxed">
            Estamos estructurando el contenido de nuestra Estrategia
            Institucional para brindarte la información más actualizada.
          </p>
